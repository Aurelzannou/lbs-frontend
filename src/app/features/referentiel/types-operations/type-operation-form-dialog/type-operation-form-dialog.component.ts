...
@Component({
  selector: 'app-type-operation-form-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './type-operation-form-dialog.component.html',
  styleUrl: './type-operation-form-dialog.component.scss'
})
export class TypeOperationFormDialogComponent implements OnInit {
  private fb = inject(FormBuilder);
  private dialogRef = inject(MatDialogRef<TypeOperationFormDialogComponent>);
  public data = inject<TypeOperation | undefined>(MAT_DIALOG_DATA);
